...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand me-auto ms-lg-0 ms-3 fw-bold fst-italic">Empleado</a>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="border-bottom py-2">
                        ...
                        <ul class="collapse nav flex-column ms-1" id="submenu2">
                            <li>
                                <a href="{{ route('emple.pedidos.listar') }}" class="nav-link px-0 ps-5 link-danger ms-4">
                                    Pedidos</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="border-bottom pb-2">
                        ...
                        <ul class="collapse nav flex-column ms-1" id="submenu3">
                            <li>
                                <a href="{{ route('emple.ventas.listar') }}" class="nav-link px-0 ps-5 link-danger ms-4">
                                    Ventas</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="border-bottom pb-2">
                        ...
                        <ul class="collapse nav flex-column ms-1" id="submenu4">
                            <li>
                                <a href="{{ route('emple.clientes.listar') }}" class="nav-link px-0 ps-5 link-danger ms-4">
                                    Clientes</a>
                            </li>
                        </ul>
                    </li>
