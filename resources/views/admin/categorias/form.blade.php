...
@section('main_content')
    <!-- CARD FORMULARIO PARA REGISTRAR CATEGORIA-->
    <div class="row justify-content-center align-items-center py-3" style="min-height: 60vh;">
        <div class="col-md-8 mb-4">
            <div class="card mb-4">
                ...
                <form action="{{ route('categorias.store') }}" method="POST" autocomplete="off" class="col-sm-9 mx-auto">
