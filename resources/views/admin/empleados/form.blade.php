...
@section('main_content')
    <!-- CARD FORMULARIO PARA REGISTRAR EMPLEADOS-->
    <div class="row justify-content-center align-items-center py-3" style="min-height: 60vh;">
        <div class="col-md-8 mb-4">
            <div class="card mb-4">
                <div class="card-header py-3 bg-warning">
                    <h5 class="mb-0">Datos de los Empleados</h5>
                </div>

                <!-- FORMULARIO EMPLEADOS -->
                <form action="{{ route('empleados.store') }}" method="POST" autocomplete="off" class="col-sm-9 mx-auto">
                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="categoria_id">
                                        ...
                                        @foreach ($categorias as $categorias)
                                            <option value="{{ $categorias->id }}">{{ $categorias->nombreCategoria }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <button type="submit" class="btn btn-success text-light mx-3" id="guardar">
                                    Guardar
                                </button>
    ...
    <!-- FIN CARD FORMULARIO PARA REGISTRAR EMPLEADOS-->
