...
@section('main_content')
    <!-- CARD FORMULARIO PARA REGISTRAR PRODUCTOS-->
    <div class="row justify-content-center align-items-center py-3" style="min-height: 60vh;">
        <div class="col-md-8 mb-4">
            <div class="card mb-4">
                ...
                <form action="{{ route('productos.store') }}" method="POST" autocomplete="off" class="col-sm-9 mx-auto">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="productos" placeholder="Nombre del producto" />
                        </div>
    ...
    <!-- FIN CARD FORMULARIO PARA REGISTRAR PRODUCTOS-->
