...
@section('main_content')
    <!-- CARD FORMULARIO PARA REGISTRAR SUCURSAL-->
    <div class="row justify-content-center align-items-center py-3" style="min-height: 60vh;">
        <div class="col-md-8 mb-4">
            <div class="card mb-4">
                ...
                <!-- FORMULARIO SUCURSAL -->
                <form action="{{ route('sucursal.store') }}" method="POST" autocomplete="off" class="col-sm-9 mx-auto">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nombreSucursal"
                                        placeholder="Ejemplo: Imprenta Julian" />
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fw-bold">Código Postal:</label>
                                    <input type="text" class="form-control" name="codigoPostal"
                                        placeholder="Código Postal" minlength="5" maxlength="5" />
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="calle"
                                        placeholder="Ejemplo: Boulevard Carlos A. Madrazo" />
                                </div>
    ...
    <!-- FIN CARD FORMULARIO PARA REGISTRAR SUCURSAL-->
                ...
                fetch(form.action, {
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            ...
                            Swal.fire({
                                title: '¡Error!',
                                text: 'Ha ocurrido un error al crear la sucursal.',
                                icon: 'error',
                                confirmButtonColor: '#3085d6',
                                confirmButtonText: 'Aceptar'
                            });
