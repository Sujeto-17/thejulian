...
class PedidosEmpleController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('emple.pedidos.listar', ['titulo' => $titulo, 'pedidos' => $pedidos]);
    }
    ...
    public function create(): View
    {
        ...
        return view('emple.pedidos.form', ['titulo' => $titulo, 'clientes' => $clientes, 'empleados' => $empleados, 'productos' => $productos, 'metodoPago' => $metodoPago, 'status' => $status]);
    }
    ...
    public function edit(Pedido $pedido): View
    {
        ...
        return view('emple.pedidos.editar', ['titulo' => $titulo, 'pedido' => $pedido, 'clientes' => $clientes, 'empleados' => $empleados, 'productos' => $productos, 'metodoPago' => $metodoPago, 'status' => $status]);
    }
