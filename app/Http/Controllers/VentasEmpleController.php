...
class VentasEmpleController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('emple.ventas.listar', ['titulo' => $titulo, 'ventas' => $ventas]);
    }
    ...
    public function create(): View
    {
        ...
        return view('emple.ventas.form', ['titulo' => $titulo, 'empleados' => $empleados, 'productos' => $productos, 'metodoPago' => $metodoPago]);
    }
    ...
    public function edit(Venta $venta): View
    {
        ...
        return view('emple.ventas.editar', ['titulo' => $titulo, 'venta' => $venta, 'productos' => $productos, 'metodoPago' => $metodoPago, 'empleados' => $empleados]);
    }
