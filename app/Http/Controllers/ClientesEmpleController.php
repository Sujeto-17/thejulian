...
class ClientesEmpleController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('emple.clientes.listar', ['titulo' => $titulo, 'clientes' => $clientes]);
    }
    ...
    public function create(): View
    {
        ...
        return view('emple.clientes.form', ['titulo' => $titulo, 'entidadesFederativas' => $entidadesFederativas, 'regimenFiscal' => $regimenFiscal]);
    }
    ...
    public function edit(Cliente $cliente): View
    {
        ...
        return view('emple.clientes.editar', ['titulo' => $titulo, 'cliente' => $cliente, 'entidadesFederativas' => $entidadesFederativas, 'regimenFiscal' => $regimenFiscal]);
    }
